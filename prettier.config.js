...
module.exports = {
  ...
  arrowParens: "avoid", //  在单独的箭头函数参数周围包括括号。例如: avoid x => void  always: (x)=>void
  requirePragma: false, // 仅格式化首行包含 @format 代码
  proseWrap: "preserve", // .md 文件 包装格式
  endOfLine: "auto"
};
